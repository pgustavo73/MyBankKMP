...
public val minus_circled: ImageVector
	get() {
		if (_undefined != null) {
			return _undefined!!
		}
		_undefined = ImageVector.Builder(
			...
			path(
				...
				close()
				moveTo(4.5f, 7f)
				curveTo(4.2239f, 7f, 4f, 7.2239f, 4f, 7.5f)
				curveTo(4f, 7.7761f, 4.2239f, 8f, 4.5f, 8f)
				horizontalLineTo(10.5f)
				curveTo(10.7761f, 8f, 11f, 7.7761f, 11f, 7.5f)
				curveTo(11f, 7.2239f, 10.7761f, 7f, 10.5f, 7f)
